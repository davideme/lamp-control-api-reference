...
object Paths {
     ...
     * @param lampCreate  
     */
    @Resource("/lamps") class createLamp()
     ...
     * @param lampId  
     */
    @Resource("/lamps/{lampId}") class deleteLamp(val lampId: kotlin.String)
     ...
     * @param lampId  
     */
    @Resource("/lamps/{lampId}") class getLamp(val lampId: kotlin.String)
     ...
     * @param lampUpdate  
     */
    @Resource("/lamps/{lampId}") class updateLamp(val lampId: kotlin.String)
