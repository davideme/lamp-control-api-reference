...
class Lamp(BaseModel):
    ...
    created_at: datetime = Field(description="Timestamp when the lamp was created", alias="createdAt")
    updated_at: datetime = Field(description="Timestamp when the lamp was last updated", alias="updatedAt")
