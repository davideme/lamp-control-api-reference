# php-base - PHP Slim 4 Server library for Lamp Control API
...
------------ | ------------- | ------------- | -------------
*AbstractDefaultApi* | **createLamp** | **POST** /lamps | Create a new lamp
*AbstractDefaultApi* | **listLamps** | **GET** /lamps | List all lamps
