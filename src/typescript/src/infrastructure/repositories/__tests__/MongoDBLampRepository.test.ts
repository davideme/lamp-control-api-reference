...
describe('MongoDBLampRepository', () => {
  ...
  describe('save', () => {
    ...
    test('should handle errors when saving a lamp', async () => {
      ...
      const spy = jest
        .spyOn(MongoDBLampRepository, 'connect')
  ...
  describe('findById', () => {
    ...
    test('should handle errors when finding a lamp', async () => {
      ...
      // Act & Assert
      await expect(repository.findById('5224f654-4b02-4de5-9a0d-b8e6a12a32c6')).rejects.toThrow(
        'Connection error',
      );
  ...
  describe('delete', () => {
    ...
    test('should handle errors when deleting a lamp', async () => {
      ...
      // Act & Assert
      await expect(repository.delete('5224f654-4b02-4de5-9a0d-b8e6a12a32c6')).rejects.toThrow(
        'Connection error',
      );
